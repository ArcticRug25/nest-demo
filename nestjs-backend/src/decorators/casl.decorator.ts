...
export const Can = (action: Action, subject: InferSubjects<any>, conditions?: string) =>
...
export const Cannot = (action: Action, subject: InferSubjects<any>, conditions?: string) =>
